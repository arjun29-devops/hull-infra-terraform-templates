...
terraform {
  backend "s3" {
    bucket  = "hull-idp-tfstate-qa"
    key     = "services/hull-admin-web-qa/terraform.tfstate"
    region  = "ap-south-1"
    profile = "hull-dev-test"
  }
}
 ...
 #resource "aws_ecs_cluster" "this" {
  #name = "hull-idp-ecs-cluster-qa"
#}
module "ecs" {
  cluster_name              = "hull-idp-ecs-cluster-qa"
  ...
  target_group_health_check = "/Healt/ping"
