...
variable "cloudwatch_group" {
  default = "admin-logs-prod"
}

variable "serviceName" {
  default = "admin-service-prod"
}
...
variable "repository_uri" {
  default = "743515054768.dkr.ecr.ap-south-1.amazonaws.com/comm-svc-admin-ecr-prod:latest"
}
...
variable "listener_arn_pub" {
  default = "arn:aws:elasticloadbalancing:ap-south-1:743515054768:listener/app/communication-svc-alb-pub-prod/69816bd90912e527/5af56b3520a098bc"
}
