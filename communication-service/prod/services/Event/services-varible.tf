...
variable "cloudwatch_group" {
  default = "event-logs-prod"
}

variable "serviceName" {
  default = "event-service-prod"
}
...
variable "repository_uri" {
  default = "743515054768.dkr.ecr.ap-south-1.amazonaws.com/comm-svc-event-ecr-prod:latest"
}
