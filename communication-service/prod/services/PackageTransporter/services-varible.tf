...
variable "cloudwatch_group" {
  default = "pkg-trans-logs-prod"
}

variable "serviceName" {
  default = "pkg-trans-service-prod"
}
...
variable "repository_uri" {
  default = "743515054768.dkr.ecr.ap-south-1.amazonaws.com/comm-svc-pkg-trans-ecr-prod:latest"
}
...
variable "pkg_trans_sg" {
  default = ["sg-02b9c2eba465a2fbe"]
}
