...
variable "cloudwatch_group" {
  default = "pkg-create-logs-prod"
}

variable "serviceName" {
  default = "pkg-create-service-prod"
}
...
variable "repository_uri" {
  default = "743515054768.dkr.ecr.ap-south-1.amazonaws.com/comm-svc-pkg-create-ecr-prod:latest"
}
...
variable "pkg_create_sg" {
  default = ["sg-05c93355586b6f410"]
}
